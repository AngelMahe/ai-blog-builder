...
if (!class_exists('CBIA_Admin_Router')) {
    class CBIA_Admin_Router {
        ...
        public function render_page() {
            ...
            echo '<div class="cbia-title">AI BLOG BUILDER <span class="cbia-badge-pro">PRO</span> <span class="cbia-badge-pro">MULTI-PROVIDER COMING SOON</span></div>';
            echo '</div>';
            echo '<div class="cbia-version">v' . esc_html(defined('CBIA_VERSION') ? CBIA_VERSION : '3.0.1') . '</div>';
            echo '</div>';
            ...
            if (is_callable($render)) {
                ...
                if (function_exists('cbia_log')) {
                    cbia_log(sprintf(__('No se pudo cargar la pestaña: %s', 'ai-blog-builder-pro'), (string)$current), 'ERROR');
                }
            }
