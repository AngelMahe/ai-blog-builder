...
echo '<p style="margin:8px 0;"><a class="button" href="https://platform.openai.com/api-keys" target="_blank" rel="noopener noreferrer">Get API Key</a></p>';
echo '<p class="description"><a href="' . esc_url('https://help.openai.com/en/articles/4936850-where-do-i-find-my-openai-api-key') . '" target="_blank" rel="noopener noreferrer">Como obtener tu API key de OpenAI</a></p>';
...
$variants = [
    ...
    'medium' => 'Medium (~1800-2000 palabras)',
    'long'   => 'Long (~2000-2200 palabras)',
];
