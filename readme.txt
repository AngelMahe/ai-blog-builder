...
Versión Pro de AI Blog Builder: generación avanzada con IA (texto + imágenes), reanudación con checkpoint y rellenado de imágenes pendientes. Cálculo de costes estimado y real.

== Description ==

Plugin Pro para crear posts completos con OpenAI (texto + imágenes) sin bloquear la pantalla. Procesa por tandas, reanuda con checkpoint, asigna categorías/etiquetas por reglas y permite rellenar imágenes pendientes (manual o por CRON). Requiere la versión gratuita activa.
...
3. Ve a Ajustes ? AI Blog Builder, añade tu API Key y configura.
