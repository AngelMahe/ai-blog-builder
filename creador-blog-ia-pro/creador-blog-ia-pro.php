<?php
/**
 * Plugin Name: Creador Blog IA Pro
 * Description: Version Pro de Creador Blog IA (requiere la version gratuita activa).
 * Version: 3.0
 *
 * Author: Angel
...
if (!defined('CBIA_PRO_VERSION')) define('CBIA_PRO_VERSION', '3.0');
